...
Route::get('/schedule', \App\Livewire\Schedule\Program\Index::class)->middleware('auth')->name('schedule');
Route::get('/instructors', \App\Livewire\Schedule\Instructor\Index::class)->middleware('auth')->name('instructors');
